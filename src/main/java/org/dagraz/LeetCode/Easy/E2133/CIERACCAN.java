...
/*
XOR Approach doesn't work in this problem.
One person submitted a Python code that uses XOR, but
doesn't work in Java.
Status: 217/227 Covered Test Cases
Time Complexity: O(n^2)
Space Complexity: O(1)
 */


public class CIERACCAN {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(s.checkValid(m1));
